...
const en: Dict = {
  ...
  "users.createHint": "Creates the sign-in account and its CERION profile.",
  "users.edit": "Edit user",
  "users.editHint": "Update profile details, role and assignments.",
  "users.delete": "Delete user",
  "users.deleteHint": "The profile and platform access are removed immediately.",
  "users.resetPassword": "Reset password",
  "users.toggleActive": "Toggle account active",
  "users.active": "Active",
  ...
  "users.emptyDescription": "Create the first account to get started.",
  "users.errorTitle": "Cannot load users",
  "users.errorDescription":
    "The user directory is unavailable. Check that Cloud Firestore is enabled and its rules allow access.",
  "users.noPermissionTitle": "No access",
  "users.noPermission": "Your role cannot manage user accounts.",
  "users.field.fullName": "Full name",
  "users.field.email": "Email",
  "users.field.password": "Password",
  "users.field.role": "Role",
  "users.field.school": "School",
  "users.field.classrooms": "Assigned classrooms (optional)",
  "users.field.classroomsHint": "Separate classroom names with commas.",
  "users.toast.created": "User account created.",
  ...
  "users.toast.reset": "Password reset email sent.",
  "users.error.name": "Full name is required.",
  "users.error.school": "School is required.",
  "users.error.emailInUse": "This email is already in use.",
  "users.error.invalidEmail": "Enter a valid email address.",
  "users.error.weakPassword": "Password must be at least 6 characters.",
  "users.error.permission": "You are not allowed to perform this action.",
  "users.error.generic": "The action failed. Please try again.",
  "users.accountDisabled": "Your account has been disabled.",
